...
function showResultSong(json){
    ...
    barra=document.querySelector("#barra-laterale");
...
function stampaArtistiPreferiti(json){    
    ...
    suggerimento.href='/likedArtists';
...
const sezione_post=document.querySelector("#post");
...
brani=document.querySelector("#brani-preferiti");
brani.addEventListener('click',caricaBraniPreferiti);
albums=document.querySelector("#album-preferiti");
albums.addEventListener('click',caricaAlbumPreferiti);
artists=document.querySelector("#artisti-preferiti");
artists.addEventListener('click',caricaArtistiPreferiti);
loadPost();